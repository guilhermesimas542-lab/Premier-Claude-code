...
// Espelha 1:1 o tailwind.config do app prod (ultrateste111).
// Quando o OnboardingModal for movido pra lá, os tokens/animations já vão casar.
export default {
  darkMode: ["class"],
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        vip: { DEFAULT: "hsl(var(--vip))" },
        ultra: { DEFAULT: "hsl(var(--ultra))" },
