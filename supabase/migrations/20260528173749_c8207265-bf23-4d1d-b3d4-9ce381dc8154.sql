...
CREATE INDEX IF NOT EXISTS idx_crm_journey_steps_journey
  ON public.crm_journey_steps (journey_id, step_order);
...
-- Função set_updated_at (genérica, cria se não existir)
