...
export const NewEntriesAlert = ({ betSiteUrl }: NewEntriesAlertProps) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#000636] via-[#001B70] to-[#000636] border-2 border-[#e9b949] p-6 shadow-2xl shadow-[#e9b949]/30 animate-fade-in hot-entry-alert">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 text-center md:text-left">
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-[#e9b949] blur-xl opacity-50 animate-pulse" />
            <div className="relative bg-gradient-to-br from-[#005CFF] to-[#e9b949] p-3 rounded-xl">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-[#e9b949] font-semibold">
      ...
      {/* Pulsing glow effect */}
      <div className="absolute -inset-1 bg-gradient-to-r from-[#e9b949]/20 via-[#005CFF]/20 to-[#e9b949]/20 blur-2xl -z-10 animate-pulse" />
    </div>
  );
};
