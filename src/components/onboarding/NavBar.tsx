  ...
  return (
    <div
      className={cn(
        ...
        // Sem botão Voltar no step 1 → CTA primário ocupa a linha inteira.
  ...
  return (
    ...
    >
      ...
      {hasProgress && (
        <span
          aria-hidden
          className="absolute inset-0 z-20 grid place-items-center px-6 transition-[clip-path] duration-300 ease-out"
          style={{
