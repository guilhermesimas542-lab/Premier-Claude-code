            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (locked) {
                  ...
                  e.currentTarget.style.borderColor = "rgba(16, 255, 128,0.45)";
                  e.currentTarget.style.background = "rgba(0,20,0,0.85)";
                  e.currentTarget.style.boxShadow = "0 0 16px rgba(16, 255, 128,0.1)";
                }
              }}
              onMouseLeave={(e) => {
