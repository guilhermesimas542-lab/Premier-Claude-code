        ...
        <div className="bg-gradient-to-br from-[#121826]/90 to-[#0C0F14]/90 border border-primary/20 rounded-3xl p-8 shadow-2xl backdrop-blur-xl">
          ...
          <div>
            <a
              ...
              className="block"
            >
              <div className="w-full bg-[#000000] hover:bg-[#1a1a1a] text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 hover:scale-[1.02] shadow-lg flex items-center justify-center gap-3 border border-white/10">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z" />
                </svg>
                <div className="flex flex-col items-start">
                  <span className="text-[10px] uppercase tracking-wider opacity-80">Disponível no</span>
                  <span className="text-base font-bold -mt-1">Google Play</span>
                </div>
              </div>
            </a>
          </div>
