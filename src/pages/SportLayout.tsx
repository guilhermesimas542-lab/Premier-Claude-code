    ...
    <div className="min-h-screen overflow-x-hidden w-full max-w-full pb-20 md:pb-0 relative bg-navy-dark">
      ...
      <section id="bet-iframe-section" className="w-full mt-2 max-w-7xl mx-auto px-4">
        {userHouse?.open_in_new_tab ? (
          ...
          <div className="w-full mb-2 h-[600px] sm:h-[calc(100vh-372px)] md:h-[calc(100vh-352px)] bg-gradient-to-br from-muted/40 to-muted/20 rounded-xl overflow-hidden border border-border/30 backdrop-blur-sm">
            {iframeUrl ? (
              <iframe
                ref={iframeRef}
                src={iframeUrl}
