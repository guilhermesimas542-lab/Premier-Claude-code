    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1 px-2 py-0.5 rounded-full" style={{ background: "rgba(16, 255, 128,0.1)", border: "1px solid rgba(16, 255, 128,0.3)" }}>
            <Check className="w-3 h-3" style={{ color: "#10ff80" }} />
            <span className="text-[10px] font-bold" style={{ color: "#10ff80" }}>GREEN</span>
          </div>
        </div>
        ...
        {/* Justification */}
        {entry.justification && (
          <div className="rounded-lg p-3" style={{ background: "rgba(16, 255, 128,0.03)", border: "1px solid rgba(16, 255, 128,0.1)" }}>
        ...
        >
          <Trophy className="w-5 h-5" style={{ color: "#10ff80" }} />
      ...
      <main className="container max-w-3xl mx-auto px-4 py-4 relative z-10">
          ...
          {FILTERS.map((f) => {
                ...
                <Popover key={f.key}>
                  <PopoverTrigger asChild>
                    <button
                      ...
                      style={{
                        background: filter === "custom" ? "#10ff80" : "transparent",
                        border: filter === "custom" ? "1.5px solid #10ff80" : "1.5px solid rgba(255,255,255,0.07)",
            ...
            return (
              <button
                ...
                style={{
                  background: filter === f.key ? "#10ff80" : "transparent",
                  border: filter === f.key ? "1.5px solid #10ff80" : "1.5px solid rgba(255,255,255,0.07)",
        ...
        {loading ? (
          <div className="space-y-3">
            {[...Array(6)].map((_, i) => (
              <Skeleton key={i} className="h-20 w-full rounded-xl" style={{ background: "rgba(16, 255, 128,0.05)" }} />
            ))}
          </div>
        ) : greens.length === 0 ? (
            ...
            <div ref={observerRef} className="h-10 flex items-center justify-center">
              {loadingMore && (
                <div className="flex items-center gap-2 text-sm" style={{ color: "#AAAAAA" }}>
                  <div className="w-4 h-4 border-2 rounded-full animate-spin" style={{ borderColor: "rgba(16, 255, 128,0.2)", borderTopColor: "#10ff80" }} />
                  Carregando mais...
                </div>
              )}
