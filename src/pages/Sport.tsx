...
const MOCK_TIPS: MockTip[] = [
  ...
  {
    id: 99901,
    time1_name: "Barcelona FC",
    time2_name: "Real Madrid",
    time1_logo: "",
    time2_logo: "",
    real_odd_market: "Resultado Final",
    odd_Name: "Empate",
    odd_Value: 3.25,
    odd_market: "El Clásico - La Liga",
    is_pro_plan: -1,
    expiration_date: "2026-01-20T22:00:00.000Z",
    url_iframe: "https://example.com/gratis",
    justificativa: "Nos últimos 8 clássicos, 5 terminaram empatados. Ambas equipes estão em boa fase defensiva.",
  },
  // BÁSICO - Ativa
  {
    id: 99902,
    ...
    is_pro_plan: 0,
    expiration_date: "2026-01-21T17:30:00.000Z",
    url_iframe: "https://example.com/basico1",
    justificativa: "Nos últimos 12 confrontos entre City e Liverpool, ambas marcaram em 10 deles.",
  },
  // BÁSICO - EXPIRADA HOJE 19/01/2026 (para teste)
  {
    id: 99903,
    time1_name: "Bayern Munich",
    time2_name: "Borussia Dortmund",
    time1_logo: "",
    time2_logo: "",
    real_odd_market: "Total de Gols",
    odd_Name: "Mais de 2.5",
    odd_Value: 1.55,
    odd_market: "Bundesliga - Der Klassiker",
    is_pro_plan: 0,
    expiration_date: "2026-01-19T14:00:00.000Z", // EXPIRADA HOJE
    url_iframe: "https://example.com/basico-expirado",
    justificativa: "Média de 3.8 gols por jogo nos últimos 10 confrontos diretos.",
  },
  // PRO - Ativa
  {
    id: 99904,
    ...
    is_pro_plan: 1,
    expiration_date: "2026-01-22T21:00:00.000Z",
    url_iframe: "https://example.com/pro1",
    justificativa: "PSG venceu 7 dos últimos 8 jogos em casa contra Marseille com margem de 2+ gols.",
  },
  // PRO - Ativa 2
  {
    id: 99905,
    ...
    odd_Name: "Mais de 9.5",
    odd_Value: 1.85,
    odd_market: "Serie A - Derby d'Italia",
    is_pro_plan: 1,
    expiration_date: "2026-01-23T20:45:00.000Z",
    url_iframe: "https://example.com/pro2",
    justificativa: "Média de 11.3 escanteios nos últimos 6 confrontos entre as equipes.",
  },
  // MÚLTIPLA - Ativa
  {
    id: 99906,
    time1_name: "Múltipla Premium",
    time2_name: "4 jogos",
    time1_logo: "",
    time2_logo: "",
    ...
    odd_Name: "4 seleções",
    odd_Value: 6.50,
    odd_market: "Liga dos Campeões",
    is_pro_plan: 2,
    expiration_date: "2026-01-24T19:00:00.000Z",
    url_iframe: "https://example.com/multipla",
    selections_count: 4,
    justificativa: "Combinação de 4 jogos com alta probabilidade individual acima de 75%.",
  },
  // ULTRA - Ativa
  {
    id: 99907,
    time1_name: "Ajax",
    time2_name: "Feyenoord",
    time1_logo: "",
    time2_logo: "",
    real_odd_market: "Cartões Totais",
    odd_Name: "Mais de 4.5",
    odd_Value: 1.95,
    odd_market: "De Klassieker - Eredivisie",
    is_pro_plan: 3,
    expiration_date: "2026-01-25T16:30:00.000Z",
    url_iframe: "https://example.com/ultra1",
    justificativa: "Derby com média de 5.7 cartões. Árbitro designado tem média de 6.2 cartões por jogo.",
  },
  // ALAVANCAGEM - Especial
  {
    id: 99910,
    time1_name: "",
    time2_name: "",
    ...
    is_pro_plan: 10,
    expiration_date: "2026-01-20T23:59:00.000Z",
    url_iframe: "https://example.com/alavancagem",
    special_type: "ALAVANCAGEM",
    justificativa: "Estratégia de alavancagem com gestão de banca otimizada.",
  },
  // ODDS ALTAS - Especial
  {
    id: 99911,
    ...
    is_pro_plan: 11,
    expiration_date: "2026-01-21T23:59:00.000Z",
    url_iframe: "https://example.com/odds-altas",
    special_type: "ODDS_ALTAS",
    justificativa: "Oportunidade com value betting identificado por análise estatística.",
  },
];
