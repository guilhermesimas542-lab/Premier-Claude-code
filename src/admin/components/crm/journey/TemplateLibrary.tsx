...
type UnifiedTemplate = JourneyTemplate & {
...
export function TemplateLibrary({ onClose, onCreated }: Props) {
  ...
  const builtins: UnifiedTemplate[] = JOURNEY_TEMPLATES.map((t) => ({ ...t, source: "builtin" }));
      ...
      >
        ...
        <div className="p-5 space-y-6">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-4">{builtins.map(renderCard)}</div>
          </section>
          ...
          <section className="space-y-3">
            ...
            {loadingCustoms ? (
              ...
              <div className="space-y-4">{customsUnified.map(renderCard)}</div>
            )}
          </section>
        </div>
